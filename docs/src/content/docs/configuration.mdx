...
- **Description**: Defines the text displayed in the tooltip when hovering over the button. Customize this to provide a user-friendly message. If you want to support I18N, please pass in an object like this:
...
```
:::note
The above configuration places the button on the left, shows a tooltip with "Back to top" on hover, enables smooth scrolling, makes the button visible after scrolling 20% of the page, enables the scroll progress ring with a custom red color (#ff6b6b), and customizes the SVG icon and button appearance.
:::
