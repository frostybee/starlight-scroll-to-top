...
|-----------------------|--------------------|---------------------------|-----------------------------------------------------------------------------|
| `position`            | `'left' \| 'right'` | `'right'`                 | Sets the button's position on the page (left or right).                     |
...
- **Type**: `'left' | 'right'`
- **Default**: `'right'`
- **Description**: Specifies the position of the scroll-to-top button on the page. Choose `'left'` to place the button on the left side or `'right'` for the right side.
...
- **Type**: `number`
- **Default**: `30`
- **Description**: Specifies the percentage of the page height that must be scrolled before the button becomes visible. For example, a value of `30` means the button appears after scrolling 30% of the page height.
